/*
 * NEST - Stage 12: WiGLE + WDGWars home upload
...
static void runHomeUploads() {
  ...
  nestLedSet(false, true, true);  // cyan — uploading
  ...
  if (WiFi.status() != WL_CONNECTED) {
    ...
    nestLedFlash(true, false, false, 2, 150, 100);  // red 2× — unreachable
    homeStatus = 2;
  ...
  if  (anyOk && !anyFail) { nestLedFlash(false, true, false, 2, 150, 100); homeStatus = 1; }
  else                    { nestLedFlash(true, false, false, 3,  80,  80); homeStatus = 2; }
