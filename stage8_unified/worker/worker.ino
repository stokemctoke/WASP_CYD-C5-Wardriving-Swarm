/*
 * W.A.S.P. — Unified Worker / Drone Firmware — Stage 8
 * Board: Seeed XIAO ESP32-C5 (on Piglet dev board or bare)
 *
...
static cycle_slot_t cycleBuffer[CYCLE_SLOTS];
static uint8_t      writeHead = 0;

// Accumulates entries during a single scan cycle in drone mode
static wifi_entry_t pendingWifi[MAX_WIFI_PER_SLOT];
static uint8_t      pendingWifiCount = 0;
static ble_entry_t  pendingBle[MAX_BLE_PER_SLOT];
